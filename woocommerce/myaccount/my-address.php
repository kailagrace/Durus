...
<h4 class="textuppercase title style1"><span><?php echo $page_title; ?></span></h4>
<p class="myaccount_address"> <?php echo apply_filters( 'woocommerce_my_account_my_address_description', __( 'The following addresses will be used on the checkout page by default.', 'woocommerce' ) ); ?> </p>
...
<div class="row-fluid">
  ...
  <div class="span6 address">
    <div class="woocommerce-box brad-woocommerce-form">
      <header class="title">
        <h4 class="textuppercase title style1"><span><?php echo $title; ?></span></h4>
        <a href="<?php echo wc_get_endpoint_url( 'edit-address', $name ); ?>" class="edit">
