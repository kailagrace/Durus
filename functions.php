...
function brad_themes_update($updates) {
	...
	if ( isset($updates->checked) && !empty($brad_data['themeforest_username']) && !empty($brad_data['themeforest_apikey']) ) {
		...
		require_once( get_template_directory()."/framework/theme-update/pixelentity-themes-updater/class-pixelentity-themes-updater.php");
...
/*--------------------------------------------------------------------------------------------------
	Enable custom Version of visual composer
--------------------------------------------------------------------------------------------------*/
