              ...
              <?php if(has_post_thumbnail()): ?>
                ...
                <li>
                  <div class="image hoverlay"><img src="<?php echo $src[0];?>" alt="<?php the_title();?>" />
                    <div class="overlay">
                      <div class="overlay-content"><a href="<?php echo $src2[0];?>" rel="prettyPhoto[projectSlides]" class="icon"><i class="fa-search"></i></a></div>
                    </div>
                  </div>
                </li>
                <?php } ?>
        ...
        <div class="span4">
          <div class="inner-content">
            ...
            <div class="project-info">
              ...
              <div class="clearfix"> <strong><?php echo __('Client :','brad');?></strong> <span><?php echo  get_post_meta(get_the_ID(),'brad_project_client',true);?></span> </div>
              <?php endif; ?>
              <div class="clearfix"> <strong><?php echo __('Categories :','brad');?></strong> <span><?php echo get_the_term_list($post->ID, 'portfolio_category', '', '</span> , <span>', ''); ?></span> </div>
              <?php if ( get_post_meta(get_the_ID(),'brad_portfolio-link',true) != '' ) : ?>
              <div class="clearfix"> <strong><?php echo __('Project Url :','brad');?></strong> <span><a href="<?php echo get_post_meta(get_the_ID(),'brad_portfolio-link',true);?>">
                <?php  if( get_post_meta(get_the_ID(),'brad_portfolio-link-title',true) != '' ) { echo get_post_meta(get_the_ID(),'brad_portfolio-link-title',true); } else { echo get_post_meta(get_the_ID(),'brad_portfolio-link',true); } ?>
                </a></span> </div>
              <?php endif; ?>
            </div>
            <?php if($brad_data['check_sharebox']): ?>
            <div class="post-share project-share clearfix"> <span class="share-label"> <?php echo __('Share : ','brad'); ?> </span> <span class="share-menu">
